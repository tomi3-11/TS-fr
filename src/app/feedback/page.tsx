...
export default function FeedbackPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
            ...
            <div className="grid lg:grid-cols-2 gap-16">
                ...
                <div className="space-y-8">
                    ...
                    <div className="pt-8 border-t border-slate-900 space-y-4">
                        <h3 className="font-bold text-white text-sm uppercase tracking-widest">Other Channels</h3>
                        <div className="flex gap-4">
                            <a href="mailto:noreply@techmspace.dev" className="flex items-center gap-2 text-slate-400 hover:text-blue-400 transition-colors bg-slate-900 px-4 py-3 rounded-xl border border-slate-800 w-full justify-center">
                                <span>Email Support</span>
                            </a>
                            <a href="#" className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors bg-slate-900 px-4 py-3 rounded-xl border border-slate-800 w-full justify-center">
                    ...
                    {status === "success" ? (
                        ...
                        <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                            ...
                            <div className="space-y-3">
                                <label className="text-sm font-bold text-slate-400 uppercase tracking-wider">Select Category</label>
                                    ...
                                    {CATEGORIES.map((cat) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    "flex items-center gap-3 p-3 rounded-xl border text-sm font-bold transition-all text-left",
                                                    isSelected 
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-slate-400">Name (Optional)</label>
                                    <input 
                                        type="text" 
                                        value={formData.name}
                                        onChange={e => setFormData({...formData, name: e.target.value})}
                                        className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-slate-700"
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea 
                                    ...
                                    className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-slate-700 min-h-[150px] resize-none"
                            ...
                            <Button 
                                ...
                                className="w-full h-12 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2"
                            >
                                {status === "submitting" ? (
                                    <>
      ...
      {/* 3. FOOTER */}
      <footer className="py-8 bg-slate-950 border-t border-slate-900 text-slate-600 text-sm text-center">
